...
public class MyDrawer {
    ...
    public void drawImage(BufferedImage image, Graphics2D g2d)
    {
        if(image != null)
        {
            int screensize = 2048/2;
            int w = screensize - (MyController.image.getWidth()/2);
            int h = screensize - (MyController.image.getHeight()/2);
            //Use this method to set the graphics pad.
            MyDrawer3D.setGraphicsPad(g2d);
            //Now draw the pixels
            g2d.drawImage(image,null,w,h);
