...
import cs355.model.image.MyImageHelper;
...
public class MyController implements CS355Controller, MouseListener, MouseMotionListener
{
    ...
    public static MyImageHelper image;
    ...
    //Lab 6
    public static boolean imageModeIsOn = false;
    public static boolean imageIsLoaded = false;
    ...
    {
        if(imageModeIsOn && imageIsLoaded) {
            image.edgeDetection();
            currentImage = image.getImage();
            GUIFunctions.refresh();
        }
